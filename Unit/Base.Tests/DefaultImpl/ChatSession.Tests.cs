...
namespace Base.Tests.DefaultImpl 
{
    ...
    public class ChatSessionTests
    {
        ...
        {
            if (System.IO.File.Exists(@"D:\ChatSession.txt"))
            {
                System.IO.File.Delete(@"D:\ChatSession.txt");
            }
        }
        ...
        public void Setup() 
        {
            this.chatSession = ChatSessionFactory.Instance.CreateInstance();
        }
        ...
        public void GetMessages_TestHasAllMessages() 
        {
            ...
            int messagesCount =
                this
                    .chatSession
                    //.GetMessages(null)
                    .GetMessages(message => message.OriginalMessage.Author.Name == authorName)
                    .Count();

            Assert.AreEqual(sentCount, messagesCount);
        }
